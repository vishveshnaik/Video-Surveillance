# Intelligent Video Surveillance Pipeline
...
C:\Users\vishv\OneDrive\Desktop\video-surveillance-assignment\image.png
C:\Users\vishv\OneDrive\Desktop\video-surveillance-assignment\Screenshot 2026-04-10 021946.png
...
⏱️ Performance Notes
Hardware Used: (Replace with your specs, e.g., Intel Core i7, 16GB RAM, No GPU)

Model: YOLOv8n (Nano)

Processing Speed: Averaged roughly [Insert your estimated FPS or "X frames per second"] on CPU.

Memory Usage: The pipeline maintains a lightweight memory footprint by writing frames to the VideoWriter and discarding them immediately, preventing RAM bloat on long videos.